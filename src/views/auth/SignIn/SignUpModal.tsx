                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <input
                                                ...
                                                style={{
                                                    ...inputStyle,
                                                    borderColor: errors.firstName ? 'rgba(239,68,68,0.5)' : 'rgba(255,255,255,0.1)',
                                                }}
                                                onFocus={(e) => { e.target.style.borderColor = 'rgba(47,111,237,0.6)'; }}
                                                onBlur={(e) => { e.target.style.borderColor = errors.firstName ? 'rgba(239,68,68,0.5)' : 'rgba(255,255,255,0.1)'; field.onBlur(); }}
                                            />
                                        )}
                                    />
                                    ...
                                    <Controller
                                        ...
                                        render={({ field }) => (
                                            <input
                                                ...
                                                style={{
                                                    ...inputStyle,
                                                    borderColor: errors.lastName ? 'rgba(239,68,68,0.5)' : 'rgba(255,255,255,0.1)',
                                                }}
                                                onFocus={(e) => { e.target.style.borderColor = 'rgba(47,111,237,0.6)'; }}
                                                onBlur={(e) => { e.target.style.borderColor = errors.lastName ? 'rgba(239,68,68,0.5)' : 'rgba(255,255,255,0.1)'; field.onBlur(); }}
                                            />
                                        )}
                                    />
                                        ...
                                        <div style={{ position: 'relative' }}>
                                            <input
                                                ...
                                                style={{
                                                    ...inputStyle,
                                                    paddingRight: '42px',
                                                    borderColor: errors.confirmPassword ? 'rgba(239,68,68,0.5)' : 'rgba(255,255,255,0.1)',
                                                }}
                                                onFocus={(e) => { e.target.style.borderColor = 'rgba(47,111,237,0.6)'; }}

...
const BasicInformationFields = (props: BasicInformationFields) => {
    const { type, countries, touched, errors} = props

    return (
      <AdaptableCard className="mb-4">
        <h5>{type === 'edit' ? 'Modifier les informations de base' : 'Ajouter des informations de base'}</h5>
        <p className="mb-6">{type === 'edit' ? 'Modifier les informations de base' : 'Ajouter des informations de base'}</p>

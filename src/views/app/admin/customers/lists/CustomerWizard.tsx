...
const CustomerWizard = ({ open, onClose, customer }: Props) => {
  ...
  useEffect(() => {
    ...
    apiGetCustomerCategories()
      .then((res: any) => {
        const nodes =
          res?.data?.data?.customerCategories_connection?.nodes ?? [];
        setCategories(
  ...
  useEffect(() => {
    ...
    if (customer) {
      ...
      setPremium(customer.premium ?? false);
      ...
      >
            ...
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              <div
                style={{
                  ...
                  margin: '0 auto 12px',
                  background:
                    'linear-gradient(135deg, rgba(47,111,237,0.2), rgba(47,111,237,0.05))',
        ...
        {step === 1 && (
          <div>
            ...
            {/* Type de client : Premium / Standard */}
            <div
              style={{
                marginBottom: '10px',
                display: 'flex',
                ...
                border: `1px solid ${premium ? 'rgba(234,179,8,0.35)' : 'rgba(255,255,255,0.05)'}`,
              }}
            >
              <div>
                <span
                  style={{
                    color: premium ? '#eab308' : 'rgba(255,255,255,0.7)',
                    fontSize: '13px',
                    fontWeight: 700,
                    display: 'block',
                  }}
                >
                  {premium ? '⭐ Client Premium' : 'Client Standard'}
                </span>
                <span
                  style={{ color: 'rgba(255,255,255,0.4)', fontSize: '11px' }}
                >
                  {premium
                    ? 'Accès aux offres personnalisées (« Mes offres »)'
                    : 'Catalogue uniquement — pas d’offres personnalisées'}
                </span>
              </div>
              <label
                style={{
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={() => setDeferredPayment(!deferredPayment)}
                    style={{
                      width: '16px',
                      height: '16px',
                      accentColor: '#a855f7',
              ...
              >
                ...
                >
                  <input
                    ...
                    onChange={() => setCatalogAccess(!catalogAccess)}
                    style={{
                      width: '16px',
                      height: '16px',
                      accentColor: '#22c55e',
          ...
          <div>
            ...
            >
              ...
              >
                ...
                />
                <InfoRow
                  icon={<HiLocationMarker size={14} />}
                  label="Adresse"
                  value={[address, zipCode, city].filter(Boolean).join(', ')}
                />
                <InfoRow
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow: submitting
                    ? 'none'
                    : isEdit
                      ? '0 4px 20px rgba(47,111,237,0.4)'

...
const CustomersList = () => {
  ...
  const total = useAppSelector((state: any) => state.customers?.total ?? 0)
  const loading = useAppSelector((state: any) => state.customers?.loading ?? false)
      ...
      <div className="mt-4">
        ...
        <Loading loading={loading}>
          <DataTable
            ...
            onSelectChange={(value = 10) => { setPageSize(Number(value)); setCurrentPage(1) }}

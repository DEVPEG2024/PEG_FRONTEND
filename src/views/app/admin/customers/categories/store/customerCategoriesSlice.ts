...
import {
  apiCreateCustomerCategory,
  apiDeleteCustomerCategory,
  apiGetCustomerCategories,
  apiUpdateCustomerCategory,
  CreateCustomerCategoryRequest,
  DeleteCustomerCategoryResponse,
  GetCustomerCategoriesRequest,
...
export const getCustomerCategories = createAsyncThunk(
  ...
  async (
    data: GetCustomerCategoriesRequest
  ): Promise<GetCustomerCategoriesResponse> => {
    const {
      customerCategories_connection,
    }: { customerCategories_connection: GetCustomerCategoriesResponse } =
      await unwrapData(apiGetCustomerCategories(data));
...
export const createCustomerCategory = createAsyncThunk(
  ...
  ): Promise<ApiResponse<{ createCustomerCategory: CustomerCategory }>> => {
    const response: AxiosResponse<
      ApiResponse<{ createCustomerCategory: CustomerCategory }>
    > = await apiCreateCustomerCategory(data);
...
export const updateCustomerCategory = createAsyncThunk(
  ...
  async (
    data: Partial<CustomerCategory>
  ): Promise<ApiResponse<{ updateCustomerCategory: CustomerCategory }>> => {
    const response: AxiosResponse<
      ApiResponse<{ updateCustomerCategory: CustomerCategory }>
    > = await apiUpdateCustomerCategory(data);
    return response.data;
  }
);
...
export const deleteCustomerCategory = createAsyncThunk(
  ...
  async (documentId: string): Promise<DeleteCustomerCategoryResponse> => {
    ...
    }: { deleteCustomerCategory: DeleteCustomerCategoryResponse } =
      await unwrapData(apiDeleteCustomerCategory(documentId));
...
export const { setCustomerCategory } = customerCategoriesSlice.actions;

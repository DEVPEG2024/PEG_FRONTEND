...
import { apiCreateInvoice, apiDeleteInvoice, apiGetInvoices, apiUpdateInvoice } from '@/services/InvoicesServices'
...
export const getInvoices = createAsyncThunk(
    ...
    async (data: GetInvoiceListRequest) => {
        const response = await apiGetInvoices(data.page, data.pageSize, data.searchTerm);

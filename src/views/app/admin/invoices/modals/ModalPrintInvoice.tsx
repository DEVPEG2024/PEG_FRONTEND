...
import { setPrintInvoiceDialog, setSelectedInvoice, useAppDispatch, useAppSelector } from '../store';
import { Customer } from '@/@types/customer';
import { OrderItem } from '@/@types/order';
import { VAT_AMOUNT } from './ModalEditInvoice';

const ModalPrintInvoice = () => {
  const { printInvoiceDialog, selectedInvoice } = useAppSelector((state) => state.invoices.data);
                ...
                <View style={styles.sectionFooter}>
                  ...
                  >
                    {customer?.name +
                      ...
                      ', ' +
                      customer?.city}{' '}
                    - RCS : {customer?.siretNumber} - N° TVA : {customer?.vatNumber}
                  </Text>
                  <Text
                    style={{ fontSize: 6, padding: 3, textAlign: 'center' }}
                  >

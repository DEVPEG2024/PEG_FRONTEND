...
const TEMPLATES: { icon: string; label: string; colors: TemplateColor[] }[] = [
  ...
  },
  {
    ...
    colors: [
      ...
      { name: 'Turquoise', hex: '#10b981' },
      { name: 'Menthe', hex: '#34d399' },
      { name: 'Vert sauge', hex: '#4ade80' },
      { name: 'Lavande', hex: '#818cf8' },
    ],
  },
  {
    icon: '🌅',
    label: 'Tons chauds',
    colors: [
      { name: 'Rouge vif', hex: '#f43f5e' },
      { name: 'Corail', hex: '#fb7185' },
      { name: 'Saumon', hex: '#fda4af' },
      { name: 'Pêche', hex: '#fdba74' },
      { name: 'Abricot', hex: '#fb923c' },
      { name: 'Miel', hex: '#fde047' },
    ],
  },
  {
    icon: '🤎',
    ...
    colors: [
      ...
      { name: 'Camel', hex: '#a0785a' },
      { name: 'Marron', hex: '#7c5a3c' },
      { name: 'Chocolat', hex: '#5c3d1e' },
      { name: 'Café', hex: '#292524' },
    ],
  },
];

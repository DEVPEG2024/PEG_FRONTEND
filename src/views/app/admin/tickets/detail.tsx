...
import { updatePriorityTicket, updateStatusTicket, useAppDispatch, useAppSelector } from './store'
...
const DetailTicket = () => {
    ...
    const priorityText = selectedTicket?.priority === "low" ? "Faible" : selectedTicket?.priority === "medium" ? "Moyen" : "Elevé"
              ...
              <AdaptableCard bodyClass="p-5">
                ...
                <div className="flex flex-col gap-2">
                  <Button
                    ...
                    onClick={ selectedTicket?.status === "closed" ? handleOpenTicket : handleCloseTicket}
                  >
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex flex-wrap gap-4">
                    {selectedTicket?.file && (
                    <img
                      onClick={()=>window.open(API_URL_IMAGE + selectedTicket?.file, '_blank')}

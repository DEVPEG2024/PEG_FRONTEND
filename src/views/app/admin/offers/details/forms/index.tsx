    ...
    if (!isAccepted && !isRejected) {
      return (
        <Alert showIcon className="mb-4" type="danger">
          Vous devez d'abord accepter ou refuser l'offre avant de pouvoir
...
const renderField = (field: IField) => {
  ...
  switch (field.type) {
    ...
    case 'checkbox':
      return (
        <CheckBoxSection {...field} className="mb-4" options={field.options} />
      );
    case 'select':
      return (
        <SelectSection {...field} className="mb-4" options={optionsSelect} />
      );
    case 'date':
    ...
    case 'radio':
      return (
        <RadioSection {...field} className="mb-4" options={field.options} />
      );
    default:
      return null;
  }

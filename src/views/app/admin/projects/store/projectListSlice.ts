...
import { apiChangeTaskStatus, apiCreateTask, apiGetInvoicesProject, apiGetProjects, apiCreateInvoice, apiDeleteInvoice, apiUpdateInvoice } from '@/services/ProjectServices'
...
export const getList = createAsyncThunk(
    ...
    async (data: GetProjectListRequest) => {
        const response = await apiGetProjects(data.page, data.pageSize, data.searchTerm);

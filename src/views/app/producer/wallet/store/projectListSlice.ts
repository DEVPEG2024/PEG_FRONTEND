...
import { apiChangeTaskStatus, apiCreateTask, apiGetInvoicesProject, apiGetProjects, apiCreateInvoice, apiDeleteInvoice, apiUpdateInvoice, apiGetProjectsCustomer } from '@/services/ProjectServices'
...
type Query = {
   page: number, pageSize: number, searchTerm: string, customerId: string 
}
...
export const getList = createAsyncThunk(
    ...
    async (data: GetProjectListRequest) => {
        const response = await apiGetProjectsCustomer(data.page, data.pageSize, data.searchTerm, data.customerId);

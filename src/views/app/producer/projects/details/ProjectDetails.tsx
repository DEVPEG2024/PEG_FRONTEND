...
const ProjectDetails = () => {
    ...
    const  project  = useAppSelector(state => state.projectList.data.selectedProject)
    ...
    return (
      <>
        ...
        <Container className="h-full">
          ...
          {selectedTab === "Commentaires" && <Comments project={project as IProject} />}
          {selectedTab === "Fichiers" && <Files project={project as IProject} />}
          {selectedTab === "Tâches" && <Tasks project={project as IProject} />}
          {/* {selectedTab === "Factures" && <Invoices project={project as IProject} />} */}

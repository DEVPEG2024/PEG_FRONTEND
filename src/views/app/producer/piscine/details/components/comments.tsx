...
import { createComment, deleteComment } from '@/utils/hooks/projects/useComments'
...
type TimelineCommentProps = TimeLineItemProps & { comment: IComment, projectId: string }
...
const TimelineComment = ({ comment, projectId, ...rest }: TimelineCommentProps) => {
    const userName =
    ...
    const handleDeleteComment = async () => {
      const resp = await deleteComment({_id: comment._id, projectId: projectId})
      ...
      switch (fileType) {
        ...
        case 'application':
          ...
          return (
            <div className="flex flex-col items-center justify-center">
            <div className=" bg-gray-900 rounded-md">
              <a href={API_URL_IMAGE + comment.file} target="_blank" rel="noopener noreferrer" className="w-20 h-12 flex items-center justify-center">

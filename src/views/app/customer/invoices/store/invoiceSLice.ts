...
import { apiCreateInvoice, apiDeleteInvoice, apiGetInvoiceByUserId, apiGetInvoices, apiUpdateInvoice } from '@/services/InvoicesServices'
...
export const getInvoices = createAsyncThunk(
    ...
    async (data: GetInvoiceListRequest) => {
        const response = await apiGetInvoiceByUserId(data.page, data.pageSize, data.searchTerm, data.userId);
...
const projectListSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(getInvoices.fulfilled, (state, action) => {
            state.loading = false
            state.invoices = action.payload.invoices as unknown as WritableDraft<Invoice>[]

...
const ItemDropdown = ({ handleDeleteProject, data, setIsPayProducerOpen }: { handleDeleteProject: (id: string) => void, data: IProject, setIsPayProducerOpen: (value: boolean) => void }) => {
      ...
      <>
        ...
        <Dialog isOpen={validDelete} onClose={() => setValidDelete(false)}>
          ...
          <div className="flex flex-grow items-center justify-center gap-2 mt-10">
            ...
            <Button onClick={handleConfirmDelete} className="bg-red-500 text-white" variant='solid'>Supprimer</Button>
          </div>
        </Dialog>
      </>
    );

...
export const { addToCart, removeFromCart, editSizeAndColorsCartItem, editFormAnswerCartItem, editOrderItemDocumentIdCartItem, removeFromCartItemOfOrderItem, clearCart } = cartSlice.actions
